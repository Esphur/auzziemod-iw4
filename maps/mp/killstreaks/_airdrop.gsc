...
init()
{
	...
	//addCrateType( "airdrop_mega",	"ammo", 					getDvarInt( "scr_airdrop_mega_ammo", 0 ),				::ammoCrateThink );
	//addCrateType( "airdrop_mega",	"uav", 						getDvarInt( "scr_airdrop_mega_uav", 0 ),				::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"counter_uav", 				getDvarInt( "scr_airdrop_mega_counter_uav", 0 ),		::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"sentry", 					getDvarInt( "scr_airdrop_mega_sentry", 0 ),			::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"predator_missile", 		getDvarInt( "scr_airdrop_mega_predator_missile", 0 ),	::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"precision_airstrike", 		getDvarInt( "scr_airdrop_mega_precision_airstrike", 0 ),::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"harrier_airstrike", 		getDvarInt( "scr_airdrop_mega_harrier_airstrike", 0 ),	::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"helicopter", 				getDvarInt( "scr_airdrop_mega_helicopter", 0 ),			::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"helicopter_flares", 		getDvarInt( "scr_airdrop_mega_helicopter_flares", 0 ),	::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"stealth_airstrike", 		getDvarInt( "scr_airdrop_mega_stealth_airstrike", 0 ),	::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"helicopter_minigun", 		getDvarInt( "scr_airdrop_mega_helicopter_minigun", 0 ),	::killstreakCrateThink );
	//addCrateType( "airdrop_mega",	"ac130", 					getDvarInt( "scr_airdrop_mega_ac130", 0 ),				::killstreakCrateThink );
...
dropTimeOut( dropCrate, owner )
{
	...
	//dropCrate delete();	//Unlimited CarePackage
}
